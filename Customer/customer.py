...
def login(UID,PASS):
    global flag
    with open(r"C:\Users\Fathima\Desktop\coding\+2 Project\Customer\customer_login.csv","r") as fr:
        data = csv.reader(fr)
        while True:
            for i in data:
                if UID == i[0]:
...
def signup():
    global flag
    lc=uc=sp=d=ss=0
    with open (r"C:\Users\Fathima\Desktop\coding\+2 Project\Customer\customer_login.csv","a",newline="") as f:
        with open(r"C:\Users\Fathima\Desktop\coding\+2 Project\Customer\customer_login.csv","r") as fr:
            data = csv.reader(fr)
            w = csv.writer(f)
            l = []
